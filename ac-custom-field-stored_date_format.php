 ...
 */
function acp_custom_field_stored_date_format(string $date_format, AC\Column\Context $context): string
{
 ...
 */
function acp_set_custom_field_stored_date_format(string $date_format, AC\Column\Context $context): string
{
