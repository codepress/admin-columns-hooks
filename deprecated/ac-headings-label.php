...
function ac_heading_label(string $label, AC\Setting\Context $context): string
{
    // Change column label
 ...
 */
function ac_heading_label_translate(string $label, AC\Setting\Context $context): string
{
