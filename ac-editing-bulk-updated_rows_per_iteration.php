 ...
 */
function ac_editing_bulk_reduce_records_to_update_per_iteration(int $number): int
{
    return 10; // Default is 250
}

add_filter('ac/editing/bulk/updated_rows_per_iteration', 'ac_editing_bulk_reduce_records_to_update_per_iteration');
