...
function ac_heading_label(string $label, AC\Column\Context $column, AC\TableScreen $table): string
{
    // Change column label
...
add_filter('ac/column/heading/label', 'ac_heading_label', 10, 3);
 ...
 */
function ac_heading_label_translate(string $label, AC\Column\Context $column, AC\TableScreen $table): string
{
